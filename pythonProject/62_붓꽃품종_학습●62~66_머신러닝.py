...
# 사용 방법 :
    ...
    # if__name__=='__main__': 현재 스크립트 파일이 프로그램의 시작점인지 모듈인지 판단(스크립트 파일이 메인 프로그램으로 사용될 때와 모듈로 사용될 때를 구분)
...
# <인공지능, 머신러닝, 딥러닝>
    # 인공지능 > 머신러닝 > 딥러닝
        ...
        # 머신러닝
            # 지도학습 : 강의 >> 정답 찾기 or 연관성 증명
                # 지도학습 순서 : 특징 추출 >> 좌표 표시 >> 규칙 형성 >> 예측 >> 피드백
                # - labal : 정답
...
# 0. 머신러닝 분류 알고리즘 모듈 : sklearn.svm import SVC
